...
- (void)drawRect:(CGRect)rect {
   ...
   // UIColor *themeColor = [[SMWUtility sharedInstance] hexaDecimalToColor:[SMWThemeHandler sharedInstance].selectedAppTheme.colorCode];

    //SMW: set theme color on the background for eavery condition
